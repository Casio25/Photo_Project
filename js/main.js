...
function getRandomURL() {
    ...
    const randomURL = descriptions[randomArrayURL];
    return randomURL
}
...
function getRandomComment() {
    const randomArrayNumber = getRandomNumber(0, comments.length)
    const RandomComment = comments[randomArrayNumber];
    return RandomComment
}

function getRandomName() {
    const randomArrayNumber = getRandomNumber(0, names.length)
    const RandomComment = names[randomArrayNumber];
    return RandomName
}
